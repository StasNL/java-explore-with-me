...
(
    ...
    rate     INT    NOT NULL,
    CONSTRAINT pr_likes PRIMARY KEY (event_id, user_id),
    CONSTRAINT fk_event_to_likes FOREIGN KEY (event_id) REFERENCES events (ev_id),
    CONSTRAINT fk_user_to_likes FOREIGN KEY (user_id) REFERENCES users (user_id)
);